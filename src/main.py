...
if __name__ == "__main__":
    ...
    parser.add_argument('integers', metavar='start_x start_y goal_x goal_y', type=int, nargs='+',help="Start and goal nodes' coordinates, e.g. 0 0 4 7")
    ...
    if args.jps:
        ...
        print(algorithm.find_shortest_path(start_coordinates, goal_coordinates))
